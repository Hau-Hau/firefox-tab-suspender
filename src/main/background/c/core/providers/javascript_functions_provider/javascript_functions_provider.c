...
static void (*JsChromeTabsDiscard)(uint32_t*, uint32_t, bool);
...
static void chromeTabsDiscard(uint32_t* tabsId, uint32_t size, bool isForced) {
  (*JsChromeTabsDiscard)(tabsId, size, isForced);
}
