document.addEventListener('DOMContentLoaded', function() {
  ...
  let elements = {
    ...
    neverSuspendPlayingAudio: this.getElementById(
        'never_suspend_playing_audio'),
    ...
    suspendOthersOptionInContextMenu: this.getElementById(
        'suspend_others_in_context_menu'),
    suspendLeftAndRightOptionsInContextMenu: this.getElementById(
        'suspend_left_right_in_context_menu'),
  };
  ...
  function saveOptions(e) {
    ...
    browser.storage.local.set({
      ...
      neverSuspendPlayingAudio: elements.neverSuspendPlayingAudio.checked ===
          true,
      desaturateFavicon: elements.desaturateFavicon.checked === true,
      nonNativeDiscarding: elements.nonNativeDiscarding.checked === true,
      suspendOptionInContextMenu: elements.suspendOptionInContextMenu.checked ===
          true,
      suspendOthersOptionInContextMenu: elements.suspendOthersOptionInContextMenu.checked ===
          true,
      suspendLeftAndRightOptionsInContextMenu: elements.suspendLeftAndRightOptionsInContextMenu.checked ===
          true,
    });
